...
En el archivo CSV hay información sobre las técnicas utilizadas para la detección de calidad, nombre del dataset original, el filtro de calidad, entre otros.
